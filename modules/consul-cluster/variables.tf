...
variable "allowed_outbound_cidr_blocks" {
  description = "A list of CIDR-formatted IP address ranges from which the EC2 Instances will allow connections from Consul"
  type        = list(string)
}

variable "allowed_outbound_https_cidr_blocks" {
  description = "A list of CIDR-formatted IP address ranges from which the EC2 Instances will allow HTTPS connections from Consul"
  type        = list(string)
}
